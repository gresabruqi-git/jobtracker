  ...
  <div>
    ...
    <div class="overflow-x-auto rounded-lg border border-slate-800">
      <table class="w-full min-w-[640px] text-left text-sm">
        ...
        <tbody>
          <tr v-for="row in items" :key="row.id" class="border-b border-slate-800/80 hover:bg-slate-900/50">
    ...
    <p v-if="!items.length && !err" class="mt-4 text-slate-500">No applications yet.</p>
  </div>
</template>
